...
function normalizeSeperator (str, seperator = '/') { // reference to  https://fontendnote.gitbook.io/project/source/_posts/node/node1
  if (!str) {
    return ''
  }
  return str.split(path.sep).join(seperator)
}
